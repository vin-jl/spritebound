...
public class Overworld extends JPanel implements KeyListener {
    ...
    public Overworld(){
        ...
        map = new Map("world_map.txt");
        player.addItem(CONST.ITEM_KEY);
        freezeEnemies = 0;
        loadObjects();
        loadNPCs();
        loadEnemies();
        ...
        started = false;
        startingDialogue = new NPCDialogue("dialogue/startingDialogue.txt");
    }
        ...
        if(curBattle == null) {
            ...
            for (OverworldEnemy e : enemies) {
                ...
                if (player.collide(e.getHitbox())) {
                    ...
                    curBattle = new Battle(characters, e.getEnemy(), player.getEquippedItem());
                }
            }
    ...
    private void drawKeybinds(Graphics g){
    ...
    private void loadNPCs(){
        npcs = new ArrayList<>();
        npcs.add(new OverworldNPC(510, 2784, "resources/penguin_npc.png", "dialogue/npc_dialogue_1.txt"));
        npcs.add(new OverworldNPC(CONST.TILE_SIZE * 25, CONST.TILE_SIZE * 86, "resources/penguin_npc.png", "dialogue/npc_dialogue_2.txt"));
        npcs.add(new OverworldNPC(CONST.TILE_SIZE * 33, CONST.TILE_SIZE * 86, "resources/penguin_npc.png", "dialogue/npc_dialogue_3.txt"));
        npcs.add(new OverworldNPC(CONST.TILE_SIZE * 41, CONST.TILE_SIZE * 86, "resources/penguin_npc.png", "dialogue/npc_dialogue_4.txt"));
        npcs.add(new OverworldNPC(CONST.TILE_SIZE * 62, CONST.TILE_SIZE * 89, "resources/penguin_npc.png", "dialogue/npc_dialogue_5.txt"));
    }
...
//        enemies.add(new OverworldEnemy(CONST.TILE_SIZE * 56, CONST.TILE_SIZE * 88, CONST.ENEMY_SPIDER_IMAGE_DIRECTORIES, CONST.ENEMY_SPIDER));
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(!inMenu) {
            ...
            //switch menu choice based on key
            switch (code) {
                case KeyEvent.VK_UP: {
