public final class CONST {
    ...
    public static final Item ITEM_KEY = new Item("Key", "You brandished the key! It did nothing.", "resources/key.png");
    public static final Item ITEM_PENGUIN = new Item("Penguin", "You used the penguin? All allies attack increased by 5!", "resources/penguin_npc.png");
